...
public class CommonPagePO extends AbstractPage{
	...
	public void getListItemOfOneColumn(String value) {		
	...
	public String getInforFromOfferTable(String columValue, String schema, String tableName, String columnName, String value ) throws Exception, Exception {
	...
	public BrowseDealAndCostPagePO openBrowseDealAndCostPage(WebDriver driver) {
		...
		clickToElement(driver, CommonPageUI.MENU_DYNAMIC_LINK, "/DCM_UI/browse-deals-and-costs1", "Browse Deals and Costs");
		waitForControlInvisible(driver, CommonPageUI.LOADING_BAR);
